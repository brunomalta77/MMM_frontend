...
REDIRECT_URI = "https://frnldjw2-8502.uks1.devtunnels.ms/" # This should match your Azure AD app configuration
                ...
                with col3:
                    ...
                    if st.session_state.get('access', False):
                        if st.button("Logout", key="small_button", type="secondary", use_container_width=False, 
                            ...
                            st.markdown("""
                            <meta http-equiv="refresh" content="0; url='https://frnldjw2-8502.uks1.devtunnels.ms/'" />
                            """, unsafe_allow_html=True)
